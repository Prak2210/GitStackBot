...
- A bot to help software developers during their hinderances and provide list of top stackoverflow users who can be best to reach out to and top repositories according to the doubt asked.
- Fetched data is totally dynamic and helps user to know whom to ask their doubts/problems while development.

# Check This Out
The portal runs on completely dynamic data. So when you open it, you will see a live data fetched from GitHub and StakOverFlow which has gone under several analysis.

[Portal on Heroku](http://stackanalytica-csc510.herokuapp.com/)
